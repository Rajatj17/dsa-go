...
3. When fast pointer finds new unique element, copy to slow pointer position
4. Increment slow pointer

Key insight: Use two pointers to overwrite duplicates in-place.
*/
