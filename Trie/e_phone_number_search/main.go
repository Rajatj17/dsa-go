...
// This allowes certain phone numbers to be mapped with actual words.
...
// The final list can contain words in any order. (Yes, we will use sorting at the backend to compare your result with ours😉)
